...
void DisplayUI::drawIntro() {
    ...
    if (scan.isScanning()) {
        if (currentTime - startTime >= screenIntroTime+4800) drawString(4, left(str(D_SCANNING_16), maxLen));
        else if (currentTime - startTime >= screenIntroTime+4500) drawString(4, left(str(D_SCANNING_15), maxLen));
        else if (currentTime - startTime >= screenIntroTime+4200) drawString(4, left(str(D_SCANNING_14), maxLen));
        else if (currentTime - startTime >= screenIntroTime+3900) drawString(4, left(str(D_SCANNING_13), maxLen));
        else if (currentTime - startTime >= screenIntroTime+3600) drawString(4, left(str(D_SCANNING_12), maxLen));
        else if (currentTime - startTime >= screenIntroTime+3300) drawString(4, left(str(D_SCANNING_11), maxLen));
        else if (currentTime - startTime >= screenIntroTime+3000) drawString(4, left(str(D_SCANNING_10), maxLen));
        else if (currentTime - startTime >= screenIntroTime+2700) drawString(4, left(str(D_SCANNING_9), maxLen));
        else if (currentTime - startTime >= screenIntroTime+2400) drawString(4, left(str(D_SCANNING_8), maxLen));
        else if (currentTime - startTime >= screenIntroTime+2100) drawString(4, left(str(D_SCANNING_7), maxLen));
        else if (currentTime - startTime >= screenIntroTime+1800) drawString(4, left(str(D_SCANNING_6), maxLen));
        else if (currentTime - startTime >= screenIntroTime+1500) drawString(4, left(str(D_SCANNING_5), maxLen));
        else if (currentTime - startTime >= screenIntroTime+1200) drawString(4, left(str(D_SCANNING_4), maxLen));
        else if (currentTime - startTime >= screenIntroTime+900) drawString(4, left(str(D_SCANNING_3), maxLen));
        else if (currentTime - startTime >= screenIntroTime+600) drawString(4, left(str(D_SCANNING_2), maxLen));
        else if (currentTime - startTime >= screenIntroTime+300) drawString(4, left(str(D_SCANNING_1), maxLen));
