...
const char D_INTRO_0[] PROGMEM = "wifi bully v2.1";
const char D_INTRO_1[] PROGMEM = "";
const char D_INTRO_2[] PROGMEM = DISPLAY_TEXT;
const char D_RESETTING[] PROGMEM = "scrambling...";
const char D_SCANNING_0[] PROGMEM = "      booting     ";
const char D_SCANNING_1[] PROGMEM = "      Booting     ";
const char D_SCANNING_2[] PROGMEM = "      bOoting     ";
const char D_SCANNING_3[] PROGMEM = "      boOting     ";
const char D_SCANNING_4[] PROGMEM = "      booTing     ";
const char D_SCANNING_5[] PROGMEM = "      bootIng     ";
const char D_SCANNING_6[] PROGMEM = "      bootiNg     ";
const char D_SCANNING_7[] PROGMEM = "      bootinG     ";
const char D_SCANNING_8[] PROGMEM = "      booting     ";
const char D_SCANNING_9[] PROGMEM = "      Booting     ";
const char D_SCANNING_10[] PROGMEM = "      bOoting     ";
const char D_SCANNING_11[] PROGMEM = "      boOting     ";
const char D_SCANNING_12[] PROGMEM = "      booTing     ";
const char D_SCANNING_13[] PROGMEM = "      bootIng     ";
const char D_SCANNING_14[] PROGMEM = "      bootiNg     ";
const char D_SCANNING_15[] PROGMEM = "      bootinG     ";
const char D_SCANNING_16[] PROGMEM = "     --READY--    ";
