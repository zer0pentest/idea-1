...
const char CLI_CHICKEN[] PROGMEM = "zer0/s";                // zer0, zer0s
...
const char CLI_HELP_CHICKEN[] PROGMEM = "zer0";
...
const char DSP_STS[] PROGMEM = "iots";
const char DSP_PKTS[] PROGMEM = "pkts";
const char DSP_S[] PROGMEM = "/s";
const char DSP_SCAN_DONE[] PROGMEM = "finished";

// ALL MENUS
const char D_BACK[] PROGMEM = "cancel";
const char D_REMOVE_ALL[] PROGMEM = "delete all";
const char D_SELECT[] PROGMEM = "select";
const char D_DESELECT[] PROGMEM = "deselect";
const char D_REMOVE[] PROGMEM = "delete";
...
const char D_LED[] PROGMEM = "nothing!";
...
const char D_ATTACK[] PROGMEM = "pentest";
const char D_PACKET_MONITOR[] PROGMEM = "packet monitor";
const char D_CLOCK[] PROGMEM = "clock";
const char D_CLOCK_DISPLAY[] PROGMEM = "display time";
const char D_CLOCK_SET[] PROGMEM = "set time";

// SCAN MENU
const char D_SCAN_APST[] PROGMEM = "scan AP + iot";
const char D_SCAN_AP[] PROGMEM = "scan APs";
const char D_SCAN_ST[] PROGMEM = "scan iot devices";

// SHOW MENU
const char D_ACCESSPOINTS[] PROGMEM = "APs ";
const char D_STATIONS[] PROGMEM = "iot devices ";
const char D_NAMES[] PROGMEM = "names ";
const char D_SSIDS[] PROGMEM = "ssids ";

// SSID LIST MENU
const char D_CLONE_APS[] PROGMEM = "clone APs";
const char D_RANDOM_MODE[] PROGMEM = "random shit";

// ATTACK MENU
const char D_DEAUTH[] PROGMEM = "deauth";
const char D_BEACON[] PROGMEM = "flood";
const char D_PROBE[] PROGMEM = "confuse";
...
const char D_SEEN[] PROGMEM = "first seen:";
...
const char SS_JSON_DEFAULT[] PROGMEM = "{\"random\":false,\"ssids\":[[\"zer0\",false,23],[\"0rez0rez0rez0rez\",false,22],[\"zer0flooderv2.1\",false,24],[\"zer0inthehouse\",false,22],[\"0000000000000000000000\",false,24],[\"!!z0z0!!\",false,23],[\"zer0zer0zer0zer0zer0zer0zer0\",false,22],[\"ZER0 WAS HERE\",false,20],[\"zer0 invasion\",false,22],[\"-ZER0-i-<3-you-ZER0-\",false,23],[\"zer0pwnedyou\",false,24],[\"zzzzzzzzzzzzzzzzzzzzzz\",false,23]]}";
